...
<head>
    ...
    <title>@yield('seo_title', $global_setting->home_seo_title ?? 'ONG NAMA - Association Islamique du Cameroun')</title>
    <meta name="description" content="@yield('seo_meta_description', $global_setting->home_seo_meta_description ?? 'ONG NAMA œuvre pour le développement de la communauté islamique au Cameroun')">
    
    {{-- Open Graph Tags pour Facebook, WhatsApp, etc. --}}
    <meta property="og:title" content="@yield('seo_title', $global_setting->home_seo_title ?? 'ONG NAMA - Association Islamique du Cameroun')" />
    <meta property="og:description" content="@yield('seo_meta_description', $global_setting->home_seo_meta_description ?? 'ONG NAMA œuvre pour le développement de la communauté islamique au Cameroun à travers l\'éducation, la construction de mosquées et l\'aide sociale.')" />
    <meta property="og:image" content="@yield('og_image', asset('uploads/'.$global_setting->logo))" />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />
    <meta property="og:image:type" content="image/png" />
    <meta property="og:url" content="{{ url()->current() }}" />
    <meta property="og:type" content="@yield('og_type', 'website')" />
    <meta property="og:site_name" content="ONG NAMA" />
    <meta property="og:locale" content="fr_FR" />
    
    {{-- Twitter Card Tags --}}
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="@yield('seo_title', $global_setting->home_seo_title ?? 'ONG NAMA - Association Islamique du Cameroun')" />
    <meta name="twitter:description" content="@yield('seo_meta_description', $global_setting->home_seo_meta_description ?? 'ONG NAMA œuvre pour le développement de la communauté islamique au Cameroun')" />
    <meta name="twitter:image" content="@yield('og_image', asset('uploads/'.$global_setting->logo))" />
    <meta name="twitter:site" content="@ongnama" />
    <meta name="twitter:creator" content="@ongnama" />
    
    {{-- Métadonnées spécialisées pour WhatsApp --}}
    <meta property="og:image:alt" content="Logo ONG NAMA - Association Islamique du Cameroun" />
    
    {{-- Métadonnées spécifiques aux pages (surchargeables) --}}
    @yield('meta_tags')
    ...
    <link rel="apple-touch-icon" href="{{ asset('uploads/'.$global_setting->logo) }}">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "Organization",
        "name": "ONG NAMA",
        "alternateName": "Association NAMA",
        "url": "{{ url('/') }}",
        "logo": "{{ asset('uploads/'.$global_setting->logo) }}",
        "description": "{{ $global_setting->home_seo_meta_description ?? 'ONG NAMA œuvre pour le développement de la communauté islamique au Cameroun' }}",
        "contactPoint": {
            "@type": "ContactPoint",
            "telephone": "{{ $global_setting->footer_phone ?? '+237 690 99 07 53' }}",
            "email": "{{ $global_setting->footer_email ?? 'namacameroon@gmail.com' }}",
        ...
        "founder": {
            "@type": "Person",
            "name": "Alh Ousmanou Hamadou"
        },
        "sameAs": [
            @if($global_setting->facebook)"{{ $global_setting->facebook }}"@endif
            @if($global_setting->facebook && ($global_setting->twitter || $global_setting->linkedin || $global_setting->instagram)),@endif
            @if($global_setting->twitter)"{{ $global_setting->twitter }}"@endif
            @if($global_setting->twitter && ($global_setting->linkedin || $global_setting->instagram)),@endif
            @if($global_setting->linkedin)"{{ $global_setting->linkedin }}"@endif
            @if($global_setting->linkedin && $global_setting->instagram),@endif
            @if($global_setting->instagram)"{{ $global_setting->instagram }}"@endif
        ]
    }
    </script>
    ...
    <div class="page-wrapper">
        ...
        <header class="main-header header-style-two">
            ...
            <div class="header-lower">
                ...
                <div class="main-box">
                    <div class="logo-box">
                        <div class="logo"><a href="{{ route('home') }}"><img src="{{ asset('uploads/'.$global_setting->logo) }}" alt="ONG NAMA"></a></div>
                    </div>
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="upper-box">
                        <div class="nav-logo"><a href="{{ route('home') }}"><img src="{{ asset('uploads/'.$global_setting->logo) }}" alt="ONG NAMA" title=""></a></div>
                ...
                <div class="auto-container">
                    <div class="inner-container">
                        <div class="logo">
                            <a href="{{ route('home') }}">
                                @if(Route::is('home_4'))
                                    <img src="{{ asset('uploads/'.$global_setting->logo) }}" alt="ONG NAMA">
                                @else
                                    <img src="{{ asset('uploads/'.$global_setting->logo_sticky) }}" alt="ONG NAMA">
                                @endif
                            </a>
                        </div>
                        <div class="nav-outer">
